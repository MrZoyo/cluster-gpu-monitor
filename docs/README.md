...
| 部署常驻服务 | [部署指南](DEPLOYMENT.md) | release 布局、systemd、Caddy、备份、迁移与排障 |
...
2. 完成[部署指南](DEPLOYMENT.md)第 1～4 节的公共步骤。
3. 在 HTTP、域名 HTTPS 或 DuckDNS 三条访问路径中选择一条。
4. 上线前逐项完成部署文档中的安全清单和健康检查。
